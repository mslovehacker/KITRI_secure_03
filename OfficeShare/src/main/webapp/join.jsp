    ...
    <section class="u-align-center u-clearfix u-gradient u-section-1" id="carousel_a193">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-form u-form-1">
          <form action="joinAction.do" id="joinForm" method="POST" class="u-clearfix u-form-spacing-0 u-form-vertical u-inner-form" style="padding: 0;" source="custom" name="form">
            ...
            <div class="u-form-date u-form-group u-form-partition-factor-2 u-form-group-5">
              ...
              <input type="date" id="birth" name="birth" class="u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle" required="">
            </div>
            <div class="u-form-group u-form-partition-factor-2 u-form-phone u-form-group-6">
              ...
              <input type="tel" placeholder="Enter your phone (e.g. 000-0000-0000)" id="phone" name="phone" class="u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle" required="">
              <span id="phoneCaution"></span>
            </div>
            <div class="u-form-email u-form-group u-form-group-7">
              ...
              <span id="emailCaution"></span>
            </div>
            <div class="u-form-group u-form-select u-form-group-8">
              <label for="select-824f" class="u-label u-label-8">Gender</label>
        ...
        <input disabled class="u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle">
            ...
            <div class="u-align-right u-form-group u-form-submit u-form-group-11">
        ...
        <input type="button" value="회원 가입" class="u-border-none u-btn u-button-style u-btn-2" onclick="join()">
      </div>
    </section>
