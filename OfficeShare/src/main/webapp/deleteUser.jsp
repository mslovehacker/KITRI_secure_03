    ...
    <section class="u-align-center u-clearfix u-gradient u-section-1" id="carousel_a193">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-form u-form-1">
          ...
          <form action="deleteAction.do" id="deleteForm" method="POST" class="u-clearfix u-form-spacing-0 u-form-vertical u-inner-form" style="padding: 0;" source="custom" name="form">
        
            <div class="u-form-group u-form-group-1"><br/>
              <label for="text-ceff" class="u-label u-label-1">User Id</label>
              <input type="text" placeholder="아이디를 입력하세요..." id="id" name="id" class="u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle" required="required">
              <input type="hidden" id="sessionId" value="${loginId}">
            </div>
            <div class="u-form-group u-form-name u-form-group-2">
              <label for="name-f2a8" class="u-label u-label-2">User Pw</label>
              <input type="password" placeholder="비밀번호를 입력하세요..." id="pw" name="pw" class="u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle" required="">
            </div>
        ...
        <span id="deleteCaution"></span>
        <input type="button" value="회원 탈퇴" onclick="deleteUser()" class="u-border-none u-btn u-button-style u-btn-2">
        </form>
      </div>
    </section>
