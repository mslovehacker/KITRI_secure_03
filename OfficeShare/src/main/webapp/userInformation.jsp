      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-text u-text-1">My Inf</h2>
         <div class="u-form u-form-1">
          ...
          <form action="#" id="informationForm" method="POST" class="u-clearfix u-form-spacing-0 u-form-vertical u-inner-form" style="padding: 0;" source="custom" name="form">
            ...
            <div class="u-form-group u-form-name u-form-group-2">
              ...
              <input type="text" id="name" name="name" value="${user.name}" disabled class="u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle" required="">
            </div>
            <div class="u-form-date u-form-group u-form-partition-factor-2 u-form-group-3">
              ...
              <input type="date" id="birth" name="birth" value="${user.birth}" disabled class="u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle" required="">
            </div>
            <div class="u-form-group u-form-partition-factor-2 u-form-phone u-form-group-4">
              ...
              <input type="tel" id="phone" name="phone" value="${user.phone}" disabled class="u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle" required="" pattern="000-0000-0000">
            </div>
            <div class="u-form-email u-form-group u-form-group-5">
              <label for="email-f2a8" class="u-label u-label-5">E-mail</label>
              <input type="email" id="email" name="email" value="${user.email}" disabled class="u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle" required="">
            </div>
            <div class="u-form-group u-form-select u-form-group-6">
              <label for="select-824f" class="u-label u-label-6">Gender</label><br/>             
              <input type="radio" name="gender" value="M" <c:if test="${user.gender=='M'}"> checked="checked" </c:if> disabled required="required">남 
		        <input type="radio" name="gender" value="F" <c:if test="${user.gender=='F'}"> checked="checked" </c:if>  disabled>여 *
            ...
            <div class="u-form-group u-form-group-7">
              ...
              <input type="text" id="field" name="field" value="${user.field}" disabled class="u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle">
            </div>
            <div class="u-form-address u-form-group u-form-group-8">
              <label for="address-481b" class="u-label u-label-8">Address</label>
              <input type="text" id="address" name="address" value="${user.address}" disabled class="u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle">
            </div>
        ...
        <input type="button" value="회원 정보 수정" class="u-border-none u-btn u-button-style u-btn-2" onclick="location.href='changeUserInformation.do'" >
		<input type="button" value="회원 탈퇴" class="u-border-none u-btn u-button-style u-btn-3" onclick="location.href='deleteUser.do'">
        </form>
