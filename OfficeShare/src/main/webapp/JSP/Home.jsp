...
<body class="u-body u-overlap u-overlap-contrast u-palette-1-base">
			...
			<nav
				...
				<div class="u-custom-menu u-nav-container">
					<ul
						...
						<li class="u-nav-item"><a
							class="u-button-style u-nav-link u-text-black u-text-hover-white"
							href="Board.html" style="padding: 18px 14px;">Board</a></li>
					...
					<div class="u-layout-row">
						...
						<div
							...
							<div class="u-container-layout u-container-layout-2">
								...
								<p class="u-text u-text-6">Duis aute irure dolor in
									reprehenderit in voluptate velit esse cillum dolore eu fugiat
									nulla pariatur.</p>
						...
						<div
							...
							<div class="u-container-layout u-valign-top u-container-layout-3">
								...
								<p class="u-text u-text-9">Duis aute irure dolor in
									reprehenderit in voluptate velit esse cillum dolore eu fugiat
									nulla pariatur.</p>
						...
						<div
							...
							<div class="u-container-layout u-valign-top u-container-layout-4">
								...
								<p class="u-text u-text-12">Duis aute irure dolor in
									reprehenderit in voluptate velit esse cillum dolore eu fugiat
									nulla pariatur.</p>
	...
	<section class="pointer-event u-carousel u-slide u-block-98f9-1"
		...
		S29.964,45.019,27.454,45.019z"></path>
										...
										<p class="u-text u-text-custom-color-2 u-text-2">
											ë¹ ë¥¸ ìëì ì¸í°ë·!<br>ë§¤ëë¬ì´ ì¸í°ë·
											ê°ì ìì²­!<br>ê³µë¶ì ê´í ì ë³´ë ë¹ ë¥´ê²!
										</p>
									</div>
								</div>
								<div
	...
	c0,1.77,0.983,3.361,2.566,4.153l9.553,4.776C56.513,48.374,58,50.78,58,53.457V55.5z"></path></svg></span>
										...
										<p class="u-text u-text-custom-color-2 u-text-4">
											ë°©ììì¤ì ê°ì¶ íìì´ë¹ë£¸!<br>íí,
											ê³¼ì¸, ì¹êµ¬ë¤ê³¼ ê³µë¶ê¹ì§!<br>ë¹íë¡ì í°
											êµ¬ë¹ ìë£
										</p>
									</div>
								</div>
								<div
									...
									<div class="u-container-layout u-container-layout-3">
										...
										<p class="u-text u-text-custom-color-2 u-text-6">
											ì§ì¤ë ¥ up!<br>ê³µë¶ì ëì ëë<br>&nbsp;ë°±ì
											ìì ìì¤<br>
										</p>
									</div>
								</div>
		...
		s8,3.589,8,8S31.411,35,27,35z"></path>
										...
										<h3
											class="u-align-center u-custom-font u-font-raleway u-text u-text-7">ì¥ë¹ëì¬</h3>
										<p
