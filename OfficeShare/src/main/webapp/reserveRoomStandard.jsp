...
c6.177,6.18,9.262,14.271,9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z"></path></svg>
        ...
        <p class="u-text u-text-2">
          <span style="font-size: 1.125rem;">Price per Month<br>
            <br>450,000 won<br>
          </span>
          <br>
        </p>
        <div class="u-form u-form-1">
          <form action="getRoomIdCont.do" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="reservationForm" id="reservationForm" style="padding: 10px;">
            <div class="u-form-date u-form-group u-form-group-2">
              <label for="date-830a" class="u-form-control-hidden u-label"></label>
              <input type="date" placeholder="MM/DD/YYYY" id="start" name="start" onclick="forSetDate()" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
	            <script>
            ...
            <div class="u-form-group u-form-radiobutton u-form-group-1">
              <div class="u-form-radio-button-wrapper">
                <input type="radio" id="term" name="term" value="1" onclick="endingDate()">
                <label class="u-label" for="radiobutton">1개월 </label>
                <br>
                <input type="radio" id="term" name="term" value="3" onclick="endingDate()">
                <label class="u-label" for="radiobutton">3개월 </label>
                <br>
                <input type="radio" id="term" name="term" value="6" onclick="endingDate()">
                <label class="u-label" for="radiobutton">6개월 </label>
                <br>
              </div>
            </div>
            ...
            <div class="u-form-date u-form-group u-form-group-3">
              ...
              <input type="date" placeholder="MM/DD/YYYY" id="end" name="end" Readonly class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
              <input type="hidden" id="category" name="category" value="standard">
            </div>
            <div class="u-align-left u-form-group u-form-submit">
            <!-- <input type="button" value="조회하기" onclick="endingDate()" class="u-btn u-btn-submit u-button-style u-btn-1"><br/> -->
            <input type="button" name="check" value="예약하기" id="makeReservation" disabled onclick="searchDate()" class="u-btn u-button-style u-hover-palette-1-dark-1 u-palette-1-base u-btn-1">
            </div>
