...
<head>
  ...
  <body class="u-body"><header class="u-clearfix u-gradient u-header u-header" id="sec-8385">
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-5fbe">
      ...
      <form action="boardModify.do" method="POST" class="u-clearfix u-form-spacing-0 u-form-vertical u-inner-form" style="padding: 0;">
      <div class="u-clearfix u-sheet u-sheet-1">
	   ...
	   <div class="u-clearfix u-sheet u-sheet-1">
	     ...
	     <table class="u-table-entity u-table-entity-1">
            ...
            <td > ID<input type="text" readonly value = "${LIST.id}" name = "userid" disabled>           
                  Date<input type="text" readonly value = "${LIST.writeAt}" name = "date" disabled></td>
            </tr>  
            ...
            <thead class="u-palette-2-light-1 u-table-header u-table-header-1">
              ...
              <tr style="height: 79px;">
                ...
                <th class="u-border-1 u-border-grey-50 u-table-cell u-table-cell-1"> 글 제목<input type="text"  name="subject" value = "${LIST.subject}" size="50" maxlength="100" ></th> 
            ...
            <tbody class="u-table-body">
              ...
              <td class="u-border-2 u-border-grey-40 u-table-cell"> &nbsp; 내용 <br>
              <textarea name = "content"  cols="100" rows="25">${LIST.content}</textarea> 
              </tr>
              ...
              <input type="hidden" value = "true" name = "protect" readonly></input>              
              <input type ="button" value = "완료" class="u-active-custom-color-7 u-border-2 u-border-black u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-3 u-text-body-alt-color u-text-hover-white u-btn-2" onclick="mod()">
              <input type="hidden" name="code">
              <script type="text/javascript">
              function mod() {
            	  var mod_form = document.forms[0];
            	  mod_form.code.value="modOK";
            	  mod_form.submit();
              }
              </script>
            </div> 
